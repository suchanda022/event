...
function App() {
  ...
  const heroText = "Design. Execute. Amaze.";
  ...
  useEffect(() => {
    if (route !== "/") {
      setTypingIndex(heroText.length);
      return;
    }
    ...
    const interval = window.setInterval(() => {
      position += 1;
      setTypingIndex(position);
      if (position >= heroText.length) {
            ...
            <>
              <section id="home" className="hero">
                ...
                <div className="hero-content">
                  ...
                  <h1 className="hero-title">
                    {heroText.slice(0, typingIndex)}
                  </h1>
                  <p className="hero-copy">
                    We deliver unforgettable event experiences with stunning
                    stage setup, lighting, media coverage, and reliable
                    infrastructure.
                  </p>
                  <div className="hero-actions">
                    ...
                    <a
                      ...
                      href="https://wa.me/919474960506?text=Hello%20PK%20Saha%20Events%2C%20I%20would%20like%20a%20quote%20for%20my%20event."
                      target="_blank"
                      rel="noreferrer"
                    >
                      Get a Quote
              ...
              <section className="client-showcase">
                <div className="section-heading">
                  ...
                  <h2>
                    Premium event partners across government, education,
                    concerts, and corporate work.
                  </h2>
                </div>
